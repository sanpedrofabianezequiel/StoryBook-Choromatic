...
export declare const Basic: ComponentStory<({ label, size, color, allCaps, fontColor }: import("../../components/MyLabel").MyLabelProps) => JSX.Element>;
export declare const AllCaps: ComponentStory<({ label, size, color, allCaps, fontColor }: import("../../components/MyLabel").MyLabelProps) => JSX.Element>;
